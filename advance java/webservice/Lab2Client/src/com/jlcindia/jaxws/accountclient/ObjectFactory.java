 ...
 * element interface generated in the com.jlcindia.jaxws.accountclient package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _DepositResponse_QNAME = new QName(
			"http://account.jaxws.jlcindia.com/", "depositResponse");
	private final static QName _Deposit_QNAME = new QName(
			"http://account.jaxws.jlcindia.com/", "deposit");
	private final static QName _Withdraw_QNAME = new QName(
			"http://account.jaxws.jlcindia.com/", "withdraw");
	private final static QName _GetBal_QNAME = new QName(
			"http://account.jaxws.jlcindia.com/", "getBal");
	private final static QName _WithdrawResponse_QNAME = new QName(
			"http://account.jaxws.jlcindia.com/", "withdrawResponse");
	private final static QName _GetBalResponse_QNAME = new QName(
			"http://account.jaxws.jlcindia.com/", "getBalResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.jlcindia.jaxws.accountclient
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://account.jaxws.jlcindia.com/", name = "depositResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://account.jaxws.jlcindia.com/", name = "deposit")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://account.jaxws.jlcindia.com/", name = "withdraw")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://account.jaxws.jlcindia.com/", name = "getBal")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://account.jaxws.jlcindia.com/", name = "withdrawResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://account.jaxws.jlcindia.com/", name = "getBalResponse")
