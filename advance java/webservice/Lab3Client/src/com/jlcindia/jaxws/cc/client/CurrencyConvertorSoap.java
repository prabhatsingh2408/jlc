...
public interface CurrencyConvertorSoap {
	...
	@RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "com.jlcindia.jaxws.cc.client.ConversionRate")
	@ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "com.jlcindia.jaxws.cc.client.ConversionRateResponse")
