...
//		double cardBal, String cardType, int cardNo, String status) {
//	super();
//	this.cid = cid;
//	this.cname = cname;
//	this.email = email;
...
public String toString(){
	return this.cid + "\t" + this.cname + "\t" + this.email + "\t" + this.city + "\t" +
        this.cardBal + "\t" + this.cardNo + "\t" + this.cardType + "\t" + this.status;
}
}